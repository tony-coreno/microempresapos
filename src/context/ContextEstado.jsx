...
const ProveedorState = ({children}) => {
    ...
    //    const sku = listaProducto;
    //    const respuesta = await Axios.get(`/productos/carrito/${sku}`)
    //    const productos = ([...ventaProducto,respuesta.data])
    //    setVentaProducto(productos)
    //    console.log(ventaProducto)
    //  };
    //
    return ( 
        <ContextEstado.Provider value={{total,articulos,setArticulos,ventaProducto,listaProducto, ventaProducto, pagar, setPagar, listaProducto, setListaProducto, setVentaProducto, handleInputChange, handleSubmit, empleados, setEmpleados, perfil, setPerfil, setTituloPOS, tituloPos}}>
            {children}
